...
import { ConfigModule } from '@nestjs/config';  // 这是用来管理配置的模块
...
@Module({
  ...
  providers: [AppService],     // 服务：负责具体业务逻辑，像后台工作人员
})
