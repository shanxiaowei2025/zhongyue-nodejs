...
export class SalaryVerifyResponseDto {
  @ApiProperty({
    description: '薪资访问令牌',
    example:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsInVzZXJuYW1lIjoidGVzdCIsInRva2VuVHlwZSI6InNhbGFyeSIsImlhdCI6MTY5ODc0NDAwMCwiZXhwIjoxNjk4NzQ1ODAwfQ.example_signature',
  })
