...
export class EnterpriseServiceController {
  ...
  @Get('customer')
  @ApiOperation({ summary: '获取客户列表', description: '顾问会计、记账会计、管理员、超级管理员或拥有contract_action_create权限的角色可以访问' })
  ...
  @Get('customer/:id')
  @ApiOperation({ summary: '获取单个客户详情', description: '顾问会计、记账会计、管理员、超级管理员或拥有contract_action_create权限的角色可以访问' })
